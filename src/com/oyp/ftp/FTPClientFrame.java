...
public class FTPClientFrame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		CUT_LINK_ACTION.setFtpPanel(ftpPanel);
		...
		serverTextField.setText("140.143.14.134");
...
//				System.out.println("action");
	...
	private void linkButtonActionPerformed(java.awt.event.ActionEvent evt) {
		try {
			...
			boolean connectFtp = FtpClient2.connectFtp(new FtpInfo(server.trim(), port, userStr, passStr, "/"));
			if (connectFtp) { // 如果连接成功
...
//			ftpPanel.setFtpClient(MainStatic.ftpClient);// 设置FTP资源管理面板的FTP连接信息
//			// 设置下载按钮可用
